#ifndef keyer_settings_k5bcq.h
#define keyer_settings_k5bcq.h
...
#define initial_sidetone_freq 670                           // "factory default" sidetone frequency setting
...
#define initial_ptt_tail_time_tx1 780                       // PTT tail time in mS
#define initial_ptt_lead_time_tx2 0                         // PTT lead time in mS
#define initial_ptt_tail_time_tx2 780                       // PTT tail time in mS
#define initial_ptt_lead_time_tx3 0                         // PTT lead time in mS
#define initial_ptt_tail_time_tx3 780                       // PTT tail time in mS
#define initial_ptt_lead_time_tx4 0                         // PTT lead time in mS
#define initial_ptt_tail_time_tx4 780                       // PTT tail time in mS
#define initial_ptt_lead_time_tx5 0                         // PTT lead time in mS
#define initial_ptt_tail_time_tx5 780                       // PTT tail time in mS
#define initial_ptt_lead_time_tx6 0                         // PTT lead time in mS
#define initial_ptt_tail_time_tx6 780                       // PTT tail time in mS
...
#define default_length_letterspace  3                       // Antes  3
#define default_length_wordspace    7                       // Antes  7
...
#define default_ptt_hang_time_wordspace_units 0.6           //  Parece que está en segundos
...
#define tx_key_dit_and_dah_pins_active_state HIGH           // Salidas activas hacia los optoacopladores
#define tx_key_dit_and_dah_pins_inactive_state LOW          // Salidas desactivadas hacia los optoacopladores
...
#else
  #define number_of_memories byte(7)
#endif
...
#define custom_startup_field "Mod. by Pere EA3AGK"   // an example could be callsign and name, eg. "AB1XYZ Bob", (or "Worlds best operator" which requires a 20 column display), string length shouldo be no more than the number of columns on the display
