...
#define ptt_tx_1 14               // PTT ("push to talk") lines
...
#define potentiometer_enable_pin 0  // if defined, the potentiometer will be enabled only when this pin is held low; set to 0 to ignore this pin
  ...
  #define command_mode_active_led 42
...
#define correct_answer_led 41
#define wrong_answer_led 30
...
//  #define pin_straight_key 52   //antes
...
#define cw_decoder_indicator 40                           // Output - goes HIGH when cw tone is detected by OPTION_CW_DECODER_GOERTZEL_AUDIO_DETECTOR
  ...
  #define keyer_awake 0
    ...
    #define keyer_power_led 28                            // must be a PWM-capable pin
